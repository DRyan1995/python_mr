...
for line in sys.stdin:
    ...
    if current_word == word:
        if url not in output_result_obj:
            output_result_obj[url] = stats
        if 'body_loc' in obj and obj['body_loc'] is not in output_result_obj[url]['body']['location']:
        ...
        if 'title_loc' in obj and obj['title_loc'] is not in output_result_obj[url]['title']['location']:
